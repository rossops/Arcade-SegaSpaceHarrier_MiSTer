...
set -e
cd "$(dirname "$0")/.."
verilator --lint-only -Irtl/cpu/jt8051 -DSIMULATION --top-module emu -Isys -Irtl/video -Irtl/cpu/fx68k \
  ...
  rtl/cpu/sh_m68k_bus.sv rtl/cpu/sh_mcu.sv rtl/cpu/jt8051/*.v rtl/cpu/fx68k/fx68k.sv rtl/cpu/fx68k/fx68kAlu.sv rtl/cpu/fx68k/uaddrPla.sv \
