...
verilator --lint-only -DSIMULATION --top-module emu -DSH_Z80_TV80 -Isys -Irtl/video -Irtl/cpu/fx68k \
  ...
  rtl/video/sh_palette_5242.sv rtl/video/sh_tilerom.sv rtl/video/sh_tilemap_5012.sv rtl/video/sh_roadrom.sv rtl/video/sh_road.sv rtl/sh_core.sv rtl/pll.v \
