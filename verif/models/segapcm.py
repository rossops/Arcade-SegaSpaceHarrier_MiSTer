"""315-5218 SegaPCM, ported from MAME segapcm.cpp sound_stream_update.
Every segahang set is BANK_512: bank shift 12, mask 0x70 (bank bits 6:4 in
4 KB-page units, 64 KB banks). One call to tick() produces one stereo
