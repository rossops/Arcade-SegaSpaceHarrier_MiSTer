...
for f in $OWN; do
  verilator --lint-only -Irtl/cpu/jt8051 $W -Irtl/video rtl/sh_pkg.sv $f --top-module $(basename ${f%.*}) >/dev/null
done
# board top with everything it instantiates (grow this list with the milestones)
verilator --lint-only -Irtl/cpu/jt8051 $W -Wno-TIMESCALEMOD -Wno-SYNCASYNCNET -Wno-EOFNEWLINE -Irtl/video -Irtl/cpu/fx68k \
  verif/fx68k.vlt rtl/sh_pkg.sv rtl/video/sh_video_timing.sv rtl/mem/sh_dpram.sv \
  rtl/io/sh_ana_shape.sv rtl/io/sh_adc0804.sv rtl/io/sh_i8255.sv \
  rtl/cpu/sh_rom_cache.sv rtl/cpu/sh_m68k_bus.sv rtl/cpu/sh_mcu.sv rtl/cpu/jt8051/*.v rtl/cpu/fx68k/fx68k.sv rtl/cpu/fx68k/fx68kAlu.sv rtl/cpu/fx68k/uaddrPla.sv \
