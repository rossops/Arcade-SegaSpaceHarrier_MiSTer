//============================================================================
//  Sega Space Harrier / Hang-On — video timing
//  400 x 262 at 6.2937 MHz pixel clock (clk_sys/8), 320 x 224 visible.
//  MAME 0.289: m_screen->set_raw(25.1748 MHz/4, 400, 0, 320, 262, 0, 224).
//  vbl_irq is a 1-line level during VBLANK_LINE (224, the first vblank
//  line, where MAME fires IRQ4); latch_pulse at line 261 frames the bench
//  (the HANGON tilemap has no register latch of its own). The 2x output
//  grid is carried from the Y Board and unused until an enhanced mode.
//============================================================================
import sh_pkg::*;

module sh_video_timing (
    input             clk,
    input             reset,
